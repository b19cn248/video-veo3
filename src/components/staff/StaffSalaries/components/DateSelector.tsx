// Component Date Range Selector cho Staff Salaries
// Cho phép chọn khoảng thời gian để lọc thống kê lương nhân viên
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {mode === 'range' && (
                    <>
                        <span style={{ color: '#6b7280', fontSize: '12px', marginTop: '14px' }}>→</span>
                        <div>
                            <label style={{
                                fontSize: '11px',
                                color: '#6b7280',
